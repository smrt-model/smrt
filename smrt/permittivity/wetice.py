...
from .generic_mixing_formula import maxwell_garnett_for_spheres


@layer_properties("temperature", "liquid_water")
def wetice_permittivity_bohren83(frequency, temperature, liquid_water):
    """ calculate the dielectric constant of wet particules of ice using Maxwell Garnet equation using water as the baclground and 

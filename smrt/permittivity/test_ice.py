...
@pytest.mark.parametrize(
    "permittivity_model, frequency, temperature, real, imag, ratol, iatol",
    [
        (ice_permittivity_maetzler06, 10e9, 270, 3.18567, 9.093e-04, 1e-3, 1e-4),
        (ice_permittivity_maetzler06, 10e9, 250, 3.1675, 6.0571e-4, 1e-3, 1e-4),
...
@pytest.mark.parametrize(
    "permittivity_model, frequency, temperature, exp_eps_imag, atol",
    [

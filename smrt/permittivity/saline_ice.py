...
def impure_ice_permittivity_maetzler06(frequency, temperature, salinity):
    ...
    **Usage**::
    ...
    # Equation 5.36
    delta_Eimag = 1.0 / (g0 + g1 * (FREEZING_POINT - temperature))
...
def saline_ice_permittivity_pvs_mixing(
    frequency,
    temperature,
    brine_volume_fraction,
    brine_inclusion_shape="spheres",
    brine_mixing_ratio: Optional[float] = None,

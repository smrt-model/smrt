...
class StickyHardSpheres(Autocorrelation):
    ...
    def ft_autocorrelation_function(self, k):
        ...
        A_tsang_vol_vd = phi_2 / (1 - phi_2) * (
            ...
            + (3 - t * (1 - phi_2)) * Psi_tsang_vol_vd
            ) + np.cos(X) / sqrt_vint__vd  # fmt: skip
    ...
    def tau_min(self, frac_volume):
        ...
        """
        return 1.0 / 12 * (14.0 * frac_volume**2 - 4 * frac_volume - 1) / (2 * frac_volume**2 - frac_volume - 1)

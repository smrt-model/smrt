...
app.conf.update(result_backend="redis", result_serializer="pickle", result_expires=3600, accept_content=["pickle"])
...
class CeleryParallelRunner(object):
    ...
    def __call__(self, function, argument_list):
        ...
        # chunk ourselves:
        tasks = [
            _celery_call_with_single_numerical_threads.s(function, argument_list[i : i + self.chunk])

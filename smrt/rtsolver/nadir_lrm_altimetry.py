...
class NadirLRMAltimetry(object):
    ...
    Args:
        ...
        theta_inc_sampling: number of subdivisions used to calculate the incidence angular variations of surface and
            interface backscatter (the higher the better but the more computationnaly expensive). Note
        ...
        error_handling: If set to "exception" (the default), raise an exception in case of error, stopping the code.
            ...
            the error message is not accessible. This is only recommended for long simulations that sometimes produce
            an error.
    """
    ...
    def solve(self, snowpack, emmodels, sensor, atmosphere=None, parallel_computation=False):
        """
    ...
    def vertical_scattering_distribution(self, return_contributions, mu_i=1.0):
        ...
        # Lacroix 2008) and "interfaces" or 'surface' scattering (symbol pvl in Eq 9 in Lacroix 2008)
        ...
        if self.snowpack.substrate is not None:
            ...
            interface_echo += [
                ...
                + (
                    ...
                    .diagonal[0]
                    .squeeze()
                    # use the roughness_rms of the interface if it exists

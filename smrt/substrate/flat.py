...
class Flat(Substrate):
    ...
    def specular_reflection_matrix(self, npol, frequency, eps_1, mu1, compute_coherent_only):
...
"""
    ...
    def absorption_matrix(self, npol, frequency, eps_1, mu1, compute_coherent_only):

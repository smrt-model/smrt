...
@pytest.mark.parametrize(
    ...
    [
        ("DENSITY_OF_ICE", globalconstants.DENSITY_OF_ICE, 916.7),
        ("FREEZING_POINT", globalconstants.FREEZING_POINT, 273.15),
        ("PERMITTIVITY_OF_AIR", globalconstants.PERMITTIVITY_OF_AIR, 1),
        ("C_SPEED", globalconstants.C_SPEED, 2.99792458e8),
    ],
)

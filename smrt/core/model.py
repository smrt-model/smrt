...
from smrt.runner.joblib_runner import JoblibParallelRunner
from smrt.runner.sequential_runner import SequentialRunner
...
class Model(object):
    ...
    def prepare_simulations(self, sensor, snowpack, snowpack_dimension, snowpack_column):
        ...
        if lib.is_sequence(sensor):
            ...
            simulations = (prepare_recursive(se, sensor_configurations, sp) for se, sp in zip(sensor, snowpack, strict=False))
    ...
    def prepare_emmodels(self, sensor, snowpack):
        ...
        emmodel_instances = [
            ...
            for emmodel, emmodel_options, layer in zip(emmodel_list, emmodel_options_list, snowpack.layers, strict=False)
        ]
